...
import {Upload, FileText, BarChart3, PieChart, Brain, Zap, TrendingUp, Database} from "lucide-react";
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-12">
                     ...
                     <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/70 backdrop-blur-sm">
                        <CardHeader className="text-center">
                           ...
                           <CardDescription>
                              Simply drag and drop your CSV files or click to browse. Support for
                     ...
                     <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/70 backdrop-blur-sm">
                        <CardHeader className="text-center">
                           ...
                           <CardDescription>
                              Automatically generate bar charts, line graphs, pie charts, and more
                              from your data.
                           </CardDescription>
                        </CardHeader>
                     </Card>
                     ...
                     <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/70 backdrop-blur-sm">
                        <CardHeader className="text-center">
                           ...
                           <CardDescription>
                              Discover patterns, trends, and statistical insights automatically
